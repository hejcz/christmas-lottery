...
public class DefaultMatchingEngine implements MatchingEngine {
     ...
     * Hungarian algorithm jest deterministyczny. Żeby wprowadzić element losowości można
    ...
    /**
     * @return macierz kosztów do Hungarian Algorithm. Kosztem jest liczba dopasowań w historii
     * takich że i-ty user kupował prezent j-temu.
     */
    ...
    /**
     * Przekształca wynik Hungarian Algorithm w pary kupujący - obdarowywany.
